...
{
    return (
        <section className="bg-stone-100 h-screen w-screen font-Noto">
            <div className="h-[20%] lg:h-[15%] mx-auto flex flex-col gap-4 justify-center items-center">
                <h1 className="text-4xl text-center text-[#262626] uppercase">
                    My Cart
                </h1>
                <div className="h-[4px] w-[90px] bg-[#F28928] rounded-md"> </div>
            </div>
            <div className="w-[95%] mx-auto bg-[#180101] h-[80%] lg:h-[85%] rounded-md relative">
